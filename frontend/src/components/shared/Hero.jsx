    ...
    <div className="relative w-full h-[470px] flex flex-col md:flex-row items-center justify-between bg-black px-8 py-12">
      ...
      <div className="flex-shrink-0 mb-8 md:mb-0 md:w-1/2 flex justify-center items-center">
        <img 
          ...
          className="h-[400px] w-[450px] rounded-[10px] shadow-lg"
        />
      </div>
      ...
      <div className="text-center md:text-left md:w-1/2">
        ...
        <div className="flex items-center border rounded-full bg-gray-800">
          <CiSearch className="text-gray-400 h-6 w-6 mx-3" />
          <input 
            type="text" 
            placeholder="Search or type keyword" 
            className="w-full bg-transparent text-white px-3 py-2 placeholder-gray-400 border-none outline-none rounded-l-full"  onChange={(e) => setQuery(e.target.value)} 
          />
          <button  onClick={searchJobHandler} className="bg-[#F83002] text-white px-4 py-2 rounded-r-full hover:bg-[#d72b01] transition duration-300">
            Find Jobs
          </button>
        </div>
      </div>
